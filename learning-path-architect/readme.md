...
For a fast setup, see **[QUICK_START.md](./QUICK_START.md)**

### Complete Setup Guide
For detailed step-by-step instructions, configuration options, troubleshooting, and best practices, see **[SETUP_GUIDE.md](./SETUP_GUIDE.md)**

### Basic Steps
1. Make sure you have Microsoft 365 Copilot in your tenant.
2. Access Copilot studio agent builder at [copilotstudio.microsoft.com](https://copilotstudio.microsoft.com)
3. Open home page and paste instructions in "Describe your agent to create it" field
4. Add description to refine agents behavior: "Learning Path Architect creates personalized learning journeys for career development"
5. Wait for agent to be created (may take a few minutes).
6. Try out your agent in the same window.
7. Grant necessary permissions for work context analysis (optional).
